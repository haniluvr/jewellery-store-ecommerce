...
<div style="text-align: center; padding: 2rem 0;">
    <h1 style="color: #1A1A1A; font-family: 'Playfair Display', serif; font-size: 2rem; margin-bottom: 1rem;">Reset Your Password</h1>
    <p style="font-size: 1.1rem; color: #555; margin-bottom: 2rem; font-weight: 300;">
        You requested to reset the password for your Éclore portfolio.
    </p>
    ...
    <div style="background: #FAFAFA; border-radius: 0; padding: 2rem; margin: 2rem 0; border: 1px solid #eeeeee; border-top: 2px solid #1A1A1A;">
        <h2 style="color: #1A1A1A; font-family: 'Playfair Display', serif; font-size: 1.25rem; margin-bottom: 1rem;">Reset Your Password</h2>
        <p style="color: #555; font-weight: 300; margin-bottom: 1.5rem;">
            Click the secure link below to reset your authentication credentials.
        </p>
    ...
    <div style="background: #FAFAFA; border: 1px solid #eeeeee; padding: 1rem; margin: 1rem 0;">
        <p style="color: #555; font-weight: 300; margin: 0; font-size: 0.875rem;">
            <strong>Security Notice:</strong> If you did not request this password reset, please disregard this email. Your authentication will maintain its current integrity.
        </p>
    </div>
