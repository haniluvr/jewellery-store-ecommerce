    ...
    >
            ...
            <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('admin/images/user/user-02.jpg') }}"
                      alt="User"
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('admin/images/user/user-03.jpg') }}"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
      ...
      >
        ...
        >
          ...
          <span class="text-theme-sm mr-1 block font-medium"> {{ Auth::guard('admin')->user()->first_name ?? 'Admin' }} </span>
        ...
        >
          <div>
            ...
            >
              {{ Auth::guard('admin')->user()->full_name ?? 'Admin User' }}
            </span>
            <span
          ...
          <a
            ...
            class="group text-theme-sm mt-3 flex w-full items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
          >
            <svg
